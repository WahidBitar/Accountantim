...
Personal lending is universal. A friend borrows money for an emergency. A business partner takes a short-term advance. A family member receives gold as part of a cultural transaction. These debts accumulate across currencies, people, and time.

**How people cope today:**

- **Spreadsheets** — functional but fragile, no sharing, no reporting, easy to lose
- **Chat messages** — "remember you owe me 500" buried in a thread from six months ago
- **Memory** — the most common and least reliable system
- **Splitwise** — designed for group expense splitting, not ongoing personal lending; recently paywalled core features (multi-currency, >3 daily entries); 65% one-star reviews on Trustpilot
- **Enterprise accounting tools** — Sage, SoftLedger at $500+/month, designed for corporations, not individuals tracking personal debts

None of these handle precious metals. None generate shareable account statements. None support transferring a debt from one person to another. The result: disputes, forgotten debts, strained relationships, and lost money.
...
| Debt transfers | Yes | No | No | Yes (complex) |
| Shareable statements | Yes (link, no account) | No | No | PDF export |
...
People who frequently lend money to friends and family, or borrow from them — especially across cultures where informal lending is common and may involve gold or multiple currencies. They need a simple way to keep track without awkward conversations or lost records.

**Secondary: Small business owners**
Freelancers, shop owners, and small traders who extend informal credit to customers or partners. They need per-contact account statements and multi-currency support but don't need (or can't afford) full accounting software. Their core workflow (record credit, check balance, share statement) is identical to the primary persona — no separate feature set is required in MVP.

**Launch market:** Arabic-speaking communities first, with bilingual (Arabic + English) interface from day one. This market has strong cultural alignment with the product's multi-currency and precious metals capabilities.

## Business Model

**Phase 1 — Free:** Full functionality, no limits. Build user base and validate product-market fit.

**Phase 2 — Freemium:** New users get full access up to 500 transactions or 10 contacts. Beyond that: $2.50/month or $20/year. Existing users are grandfathered. These thresholds are configurable and will be tuned based on real usage data.

The price point is deliberately low — the goal is wide adoption, not high ARPU. At scale, even modest conversion rates on a large free base generate sustainable revenue.

## Success Criteria

- **User acquisition:** 10,000 registered users within 6 months of launch
- **Activation:** 60%+ of signups record at least one debt with a named contact within their first session
- **Retention:** 40%+ monthly active rate after 90 days (active = records, edits, or views a debt entry)
- **Viral signal:** 30%+ of users generate at least one shareable statement link
- **Revenue readiness:** Validated willingness to pay through user surveys and usage patterns before enabling the paywall

## Scope

**In (MVP):**
- Responsive web application with mobile-friendly UI (bilingual: Arabic + English)
- User registration and authentication
- Contact/party management
- Debt recording (lent / borrowed) with multi-currency and precious metals support — debts preserved in original denomination
...
- Live currency and precious metal price feeds (deferred — user has a specific vision for this)
- Payment processing or settlement
- Multi-user accounts or team features
- Full accounting module for small businesses
- Counterparty debt acknowledgment/confirmation flow
- CSV import from spreadsheets and other apps
